...
import { AppRoute, RequestStatus } from 'const/const.ts';
...
const ProtectedRoute = ({ children, onlyUnAuth }: PrivateRouteProps) => {
  ...
  if (onlyUnAuth && user) {
    ...
    const from = (location.state as LocationStateProps)?.from || {
